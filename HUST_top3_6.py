...
def main(_):
    ...
    # solution = Solution(in_file_path='T.txt', out_file_path='resT2.txt', thread_num=80)
    solution = Solution(in_file_path='in4_123--.txt', out_file_path='out_dasdasdas.txt', thread_num=80)
